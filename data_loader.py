...
#        print(self.dataset_dir)
        file_list = self.format_file_list(self.dataset_dir, 'datatrain')
...
#        print(data_root)
	...
	#print([(frame_ids[i][:-1])for i in range(len(frames))])
        image_file_list = [os.path.join(data_root, subfolders[i], 
            frame_ids[i][:-1] + '.png.jpg') for i in range(len(frames))]
        cam_file_list = [os.path.join(data_root, subfolders[i], 
            frame_ids[i][:-1] + '.png_cam.txt') for i in range(len(frames))]
        all_list = {}
